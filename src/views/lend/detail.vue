...
<template>
  <div class="app-container">
    ...
    <el-table :data="lendItems" stripe style="width: 100%" border>
    ...
    <el-table :data="lendReturns" stripe style="width: 100%" border>
      <el-table-column type="index" label="序号" width="70" align="center" />
...
export default {
  ...
  methods: {
    ...
    initData() {
      lendApi.show(this.$route.params.id).then((r) => {
        this.lendDetail = r.data.result;
      });
      lendItemApi.getList(this.$route.params.id).then((r) => {
        this.lendItems = r.data.items;
      });
      lendReturnApi.getList(this.$route.params.id).then((r) => {
        this.lendReturns = r.data.items;
      });
    },
  },
};
